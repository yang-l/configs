...
- If the main agent consults wiki files directly, append the `access` log atomically; if the wiki agent handled the operation, do not double-log.
...
- Keep updates silent unless a new page is created.
